...
class DRN(nn.Module):
    def __init__(self, opt, conv=common.default_conv):
        ...
        self.upsample = nn.Upsample(scale_factor=(max(opt.scale), 1.0),
        ...
        if opt.n_colors == 3:
            ...
            rgb_mean = (0.5,)
            rgb_std = (1.0,)
        self.sub_mean = common.MeanShift(opt.rgb_range, rgb_mean, rgb_std, opt.n_colors)
        ...
        self.add_mean = common.MeanShift(opt.rgb_range, rgb_mean, rgb_std, opt.n_colors, 1)
